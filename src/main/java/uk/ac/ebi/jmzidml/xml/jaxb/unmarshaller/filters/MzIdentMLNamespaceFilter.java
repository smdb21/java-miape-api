...
public class MzIdentMLNamespaceFilter extends XMLFilterImpl {
	...
	public void startElement(String uri, String localName, String qName, Attributes atts) throws SAXException {
		...
		// of context with the xxindex
		// so the namespace information is lost and we have to add it again here
		// manually
		logger.trace("Changing namespace. uri: " + uri + " \tlocalName: " + localName + " \tqName: " + qName
				+ " \tatts: " + atts);
		// if (uri.length() == 0){
