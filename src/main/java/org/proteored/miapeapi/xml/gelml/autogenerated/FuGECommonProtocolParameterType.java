 ...
 *       &lt;sequence>
 *         &lt;group ref="{http://www.psidev.info/gelml/1_1candidate}MeasurementGroup" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    GelMLSelectSubstanceMassType.class,
    GelMLImageAcquisitionAutoCalibrationType.class,
    FuGECommonProtocolGenericParameterType.class,
    GelMLElectrophoresisTemperatureType.class,
    GelMLSelectSubstanceTimeParameterType.class,
    GelMLSelectSubstanceVolumeParameterType.class,
    GelMLSelectSubstanceConcentrationType.class
})
