...
public class PeptideModificationImplFromDTASelect implements PeptideModification {
	...
	public PeptideModificationImplFromDTASelect(DTASelectModification dtaSelectModification) {
