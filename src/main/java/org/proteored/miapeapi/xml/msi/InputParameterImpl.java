...
public class InputParameterImpl implements InputParameter {
	...
	public InputParameterImpl(MSIInputParameters xmlInputParameter,
	...
	public String getFragmentMassTolerance() {
		return MSIControlVocabularyXmlFactory
				.getValue(xmlInputParameter.getFragmentMassTolerance());
	}

	@Override
	public String getFragmentMassToleranceUnit() {
		return MSIControlVocabularyXmlFactory.getUnitName(xmlInputParameter
	...
	public String getPrecursorMassTolerance() {
		return MSIControlVocabularyXmlFactory.getValue(xmlInputParameter
