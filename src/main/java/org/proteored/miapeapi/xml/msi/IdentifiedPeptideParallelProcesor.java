...
public class IdentifiedPeptideParallelProcesor extends Thread {
	...
	public IdentifiedPeptideParallelProcesor(ParIterator<MSIIdentifiedPeptide> iterator,
			Reducible<Map<String, IdentifiedPeptide>> reduciblePeptideMap, Map<String, MSIInputData> mapInputData) {
		...
		while (iterator.hasNext()) {
			try {
				...
				if (id == -1) {
					...
					msiIdentifiedPeptide.setId(MiapeXmlUtil.IdentifierPrefixes.PEPTIDE.getPrefix() + id);
				}
