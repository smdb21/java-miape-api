...
public class IdentifiedProteinSetAdapter implements Adapter<MSIIdentifiedProteinSet> {
	private final IdentifiedProteinSet proteinSet;
	private final ObjectFactory factory;
	private final MSIControlVocabularyXmlFactory cvFactory;
	private static Logger log = Logger.getLogger("log4j.logger.org.proteored");

	public IdentifiedProteinSetAdapter(IdentifiedProteinSet proteinSet, ObjectFactory factory,
	...
	public MSIIdentifiedProteinSet adapt() {
		...
		if (identifiedProteins != null) {
			...
			for (String proteinAcc : identifiedProteins.keySet()) {
				...
				log.debug("Adapting protein ( " + i + "/" + total + ") " + proteinAcc + " with " + numPeptides
						+ " peptides to XML");
				MSIIdentifiedProtein identifiedProteinXML = new IdentifiedProteinAdapter(protein, factory, cvFactory)
						.adapt();
