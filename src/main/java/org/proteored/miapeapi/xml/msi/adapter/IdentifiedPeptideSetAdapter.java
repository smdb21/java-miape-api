...
public class IdentifiedPeptideSetAdapter implements Adapter<MSIIdentifiedPeptideSet> {
	...
	public IdentifiedPeptideSetAdapter(List<IdentifiedPeptide> identifiedPeptides, ObjectFactory factory,
	...
	public MSIIdentifiedPeptideSet adapt() {
		...
		if (identifiedPeptides != null && !identifiedPeptides.isEmpty()) {
			...
			for (IdentifiedPeptide peptide : identifiedPeptides) {
				...
				ret.getMSIIdentifiedPeptide().add(new IdentifiedPeptideAdapter(peptide, factory, cvFactory).adapt());
				log.debug(i + "/" + identifiedPeptides.size() + " of the peptides");
				i++;
			}
