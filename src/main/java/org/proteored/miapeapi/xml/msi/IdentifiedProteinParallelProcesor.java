...
public class IdentifiedProteinParallelProcesor extends Thread {
	...
	public IdentifiedProteinParallelProcesor(
			ParIterator<MSIIdentifiedProtein> iterator,
	...
	@Override
	public void run() {
		Map<String, IdentifiedProtein> proteinMap = new HashMap<String, IdentifiedProtein>();
		reducibleProteinMap.set(proteinMap);
		while (iterator.hasNext()) {
			try {
				final MSIIdentifiedProtein msiIdentifiedProtein = iterator
						.next();
				proteinMap.put(msiIdentifiedProtein.getId(),
