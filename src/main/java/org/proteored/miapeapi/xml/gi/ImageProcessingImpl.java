...
public class ImageProcessingImpl implements ImageProcessing {
	...
	public Set<ImageAnalysisSoftware> getImageProcessingSoftwares() {
		Set<ImageAnalysisSoftware> imageProcessingSofware = new HashSet<ImageAnalysisSoftware>();
	...
	public Set<ImageProcessingStep> getImageProcessingSteps() {
		Set<ImageProcessingStep> imageProcessingSteps = new HashSet<ImageProcessingStep>();
		if (imageProcessingXML.getGIImageProcessingStep() != null) {
			for (GIImageProcessingAlgorithmType imageProcessingStepXML : imageProcessingXML.getGIImageProcessingStep()) {
