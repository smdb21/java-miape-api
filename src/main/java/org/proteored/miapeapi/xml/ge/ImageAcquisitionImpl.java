...
public class ImageAcquisitionImpl implements ImageAcquisition {
	...
	public ImageAcquisitionImpl(GEImageAcquisition imageAcquisitionItem, Map<String, GEGelMatrix> mapGelMatrix, Map<String, GESample> sampleMap) {
	...
	public Set<ImageAcquisitionSoftware> getImageAcquisitionSoftwares() {
		Set<ImageAcquisitionSoftware> setOfSoftwares = new HashSet<ImageAcquisitionSoftware>();
	...
	public Set<ImageAcquisitionEquipment> getImageAcquisitionEquipments() {
		Set<ImageAcquisitionEquipment> setOfImageAcquisitionEquipment = new HashSet<ImageAcquisitionEquipment>();
		List<GEImageAcquisitionEquipmentType> imageAcquisitionEquipmentList = imageAcquisitionXML.getGEImageAcquisitionEquipment();
