...
public class DirectDetectionImpl implements DirectDetection {
	...
	public Set<DirectDetectionAgent> getAdditionalAgents() {
		Set<DirectDetectionAgent> setOfSubstances = new THashSet<DirectDetectionAgent>();
	...
	public Set<DirectDetectionAgent> getAgents() {
		Set<DirectDetectionAgent> setOfDirectDetectionAgents = new THashSet<DirectDetectionAgent>();
	...
	public Set<Equipment> getDetectionEquipments() {
		Set<Equipment> setOfEquipment = new THashSet<Equipment>();
