...
public class MiapeMSActivationsMerger implements MiapeMerger<Set<ActivationDissociation>> {
	...
	public Set<ActivationDissociation> merge(Set<ActivationDissociation> miapeDataOriginal,
		...
		Set<ActivationDissociation> ret = new HashSet<ActivationDissociation>();
		...
		for (int i = 0; i < maxIndex; i++) {
			...
			Object object;
			String name = null;
			object = MergerUtil.getNonNullValue(activationDissociationOriginal,
					activationDissociationMetadata, "getName");
			if (object != null)
				name = (String) object;

			String activationType = null;
			object = MergerUtil.getNonNullValue(activationDissociationOriginal,
					activationDissociationMetadata, "getActivationType");
			if (object != null)
				activationType = (String) object;
			String gas = null;
			object = MergerUtil.getNonNullValue(activationDissociationOriginal,
					activationDissociationMetadata, "getGasType");
			if (object != null)
				gas = (String) object;
			String pressure = null;
			object = MergerUtil.getNonNullValue(activationDissociationOriginal,
					activationDissociationMetadata, "getGasPressure");
			if (object != null)
				pressure = (String) object;
			String pressureUnit = null;
			object = MergerUtil.getNonNullValue(activationDissociationOriginal,
					activationDissociationMetadata, "getPressureUnit");
			if (object != null)
				pressureUnit = (String) object;
			final ActivationDissociationBuilder builder = MiapeMSDocumentFactory
					.createActivationDissociationBuilder(name).activationType(activationType)
					.gas(gas).pressure(pressure).pressureUnit(pressureUnit);
