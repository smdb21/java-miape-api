...
public class MSMiapeFactory {
	...
	public MiapeMSDocument toDocument(MiapePrideXmlFile xmlFile, PersistenceManager databaseManager,
		...
		try {
			...
			final JAXBContext jc = JAXBContext.newInstance("org.proteored.miapeapi.xml.pride.autogenerated");
			final File file = ZipManager.decompressFileIfNeccessary(xmlFile.toFile(), false);
			final ExperimentCollection experimentCollection = (ExperimentCollection) jc.createUnmarshaller()
					.unmarshal(file);
