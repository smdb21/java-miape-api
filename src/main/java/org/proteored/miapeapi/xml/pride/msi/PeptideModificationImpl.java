...
public class PeptideModificationImpl implements PeptideModification {
	...
	public String getName() {
		...
		if (modAccession != null) {
			...
			// sometimes the accession of the modification is stored in a
			// userparam like:
			// <ModificationItem>
			// <ModLocation>1</ModLocation>
			// <ModAccession>Dimethyl:2H(4) (N-term)</ModAccession>
			// <ModDatabase>UniMod</ModDatabase>
			// <ModMonoDelta>32.056412</ModMonoDelta>
			// <additional>
			// <userParam name="UniMod" value="Dimethyl:2H(4) (N-term)" />
			// </additional>
			// </ModificationItem>
						...
						if (cvOrUserParam instanceof UserParamType) {
							...
							if (userParam.getName() != null
								...
								cvTermByAccession = PeptideModificationName.getInstance(cvManager)
										.getCVTermByAccession(new Accession(accession));
								cvDescription = null;
								if (cvTermByAccession != null)
									cvDescription = cvTermByAccession.getPreferredName();
								if (cvDescription != null) {
	...
	public Double getMonoDelta() {
		// TODO: what happens if more than one delta is reported?
	...
	public Double getNeutralLoss() {
		...
		if (additional != null) {
			...
			if (cvParamOrUserParam != null) {
				CvParamType param = (CvParamType) CVUtils.isThereThisCV(cvParamOrUserParam,
