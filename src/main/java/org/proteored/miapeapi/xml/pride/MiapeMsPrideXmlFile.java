...
public class MiapeMsPrideXmlFile extends MiapeXmlFile<MiapeMSDocument> implements MiapePrideXmlFile {
	...
	public MiapeMsPrideXmlFile(byte[] bytes) throws IOException {
		super(bytes);
	}

	public MiapeMsPrideXmlFile(File file) {
		super(file);
	}

	public MiapeMsPrideXmlFile(String name) {
		super(name);
	}
	...
	public MiapeMSIDocument toMiapeMSI() throws MiapeDatabaseException, MiapeSecurityException {
		// return MSIMiapeFactory.getFactory().create(this, dbManager, user,
		// password);
