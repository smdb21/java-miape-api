...
public class MSIMiapeFactory {
	...
	public MiapeMSIDocument toDocument(MiapeMzIdentMLFile xmlFile, PersistenceManager databaseManager,
		...
		try {
			...
			final JAXBContext jc = JAXBContext.newInstance("org.proteored.miapeapi.xml.mzidentml.autogenerated");
			final Unmarshaller unmarshaller = jc.createUnmarshaller();

			final MzIdentML mzIdentML = (MzIdentML) unmarshaller.unmarshal(file);
