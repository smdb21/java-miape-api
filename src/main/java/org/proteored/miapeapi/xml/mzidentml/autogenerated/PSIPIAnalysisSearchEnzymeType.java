...
/**
 * The details of an individual cleavage enzyme
 * 				should be provided by giving a regular expression or a CV term if a
 * 				"standard" enzyme cleavage has been performed.
 * 
...
public class PSIPIAnalysisSearchEnzymeType {
