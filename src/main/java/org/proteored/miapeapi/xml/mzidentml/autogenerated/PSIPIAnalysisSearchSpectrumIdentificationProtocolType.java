...
/**
 *  The parameters and settings of a
...
public class PSIPIAnalysisSearchSpectrumIdentificationProtocolType
    extends FuGECommonProtocolProtocolType
{
    ...
    protected PSIPIAnalysisSearchEnzymesType enzymes;
    @XmlElement(name = "MassTable")
    protected List<PSIPIAnalysisSearchMassTableType> massTable;
     ...
     * @return
     *     possible object is
     *     {@link PSIPIAnalysisSearchEnzymesType }
     *     
     */
    public PSIPIAnalysisSearchEnzymesType getEnzymes() {
        return enzymes;
    }
     ...
     *     
     */
    public void setEnzymes(PSIPIAnalysisSearchEnzymesType value) {
        this.enzymes = value;
    }
     ...
     * {@link PSIPIAnalysisSearchMassTableType }
     * 
     * 
     */
    public List<PSIPIAnalysisSearchMassTableType> getMassTable() {
        if (massTable == null) {
            massTable = new ArrayList<PSIPIAnalysisSearchMassTableType>();
        }
