...
public class IdentifiedProteinImpl implements IdentifiedProtein {
	...
	private final Map<String, FuGECommonOntologyParamType> proteinHypotesisParams;
	private final Map<String, FuGECommonOntologyParamType> dbSequenceParams;
	private final PSIPIAnalysisSearchDBSequenceType dbSequenceXML;
	private final PSIPIAnalysisProcessProteinDetectionHypothesisType proteinHypotesisXML;
