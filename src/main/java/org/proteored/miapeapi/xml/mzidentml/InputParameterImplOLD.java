...
public class InputParameterImplOLD implements InputParameter {
	...
	public String getAaModif() {
		if (protocol.getModificationParams() != null) {
			...
			for (PSIPIAnalysisSearchSearchModificationType modification : modifications) {
				sb.append(MzidentmlControlVocabularyXmlFactory.readEntireParam(modification
						.getModParam().getCvParam()));
	...
	public String getAdditionalCleavages() {
		StringBuilder sb = new StringBuilder();
		if (enzymes.size() > 1) {
			List<PSIPIAnalysisSearchEnzymeType> additionalEnzymes = enzymes.subList(1,
					enzymes.size() - 1);
			for (PSIPIAnalysisSearchEnzymeType enzyme : additionalEnzymes) {
				sb.append(MzidentmlControlVocabularyXmlFactory.readEntireParamList(enzyme
						.getEnzymeName()));
				sb.append(";");
			}
		}
	...
	public Set<Database> getDatabases() {
		...
		Set<PSIPIAnalysisSearchSearchDatabaseType> xmlProtocolDatabases = new HashSet<PSIPIAnalysisSearchSearchDatabaseType>();
	...
	public String getFragmentMassTolerance() {
		if (protocol.getFragmentTolerance() != null) {
			return MzidentmlControlVocabularyXmlFactory.readEntireCVParamList(protocol
					.getFragmentTolerance().getCvParam(), false);
		}
		return null;
	}
	...
	public String getFragmentMassToleranceUnit() {
		if (protocol.getFragmentTolerance() != null) {
			return MzidentmlControlVocabularyXmlFactory.readFirstUnitCVParamList(protocol
					.getFragmentTolerance().getCvParam());
		}
		return null;
	}
	...
	public String getNumEntries() {
		...
		for (PSIPIAnalysisSearchSpectrumIdentificationListType xmlSpectrumIdentificationList : spectrumIdentificationLists) {
			if (xmlSpectrumIdentificationList.getId().equals(
					spectrumIdentification.getSpectrumIdentificationListRef())) {
	...
	public String getPmfMassTolerance() {
		if (protocol.getFragmentTolerance() == null && protocol.getParentTolerance() != null) {
			return MzidentmlControlVocabularyXmlFactory.readEntireCVParamList(protocol
					.getParentTolerance().getCvParam(), false);
		}
		return null;
	}
	...
	public String getTaxonomy() {
		...
		for (FilterType filterType : filters) {
			if (filterType.getFilterType() != null) {
				...
				sb.append(MzidentmlControlVocabularyXmlFactory.readEntireParam(filterType
						.getFilterType()));
				sb.append(";");
			}
			...
			if (filterType.getExclude() != null) {
				sb.append("Exclude: ");
				sb.append(MzidentmlControlVocabularyXmlFactory.readEntireParamList(filterType
						.getExclude()));
				sb.append(";");
			}
	...
	private PSIPIAnalysisSearchSpectrumIdentificationType getSpectrumIdentification(
		...
		for (PSIPIAnalysisSearchSpectrumIdentificationType spectrumIdentification : spectrumIdentifications) {
			if (spectrumIdentification.getSpectrumIdentificationProtocolRef().equals(
					protocol.getId())) {
	...
	public String toString() {
		return "InputParameterImpl [getAaModif()=" + getAaModif() + ", getAdditionalCleavages()="
				+ getAdditionalCleavages() + ", getCleavageName()=" + getCleavageName()
				+ ", getCleavageRules()=" + getCleavageRules() + ", getDatabases()="
				+ getDatabases() + ", getFragmentMassTolerance()=" + getFragmentMassTolerance()
				+ ", getFragmentMassToleranceUnit()=" + getFragmentMassToleranceUnit()
				+ ", getMinScore()=" + getMinScore() + ", getMisscleavages()=" + getMisscleavages()
				+ ", getName()=" + getName() + ", getNumEntries()=" + getNumEntries()
				+ ", getPmfMassTolerance()=" + getPmfMassTolerance()
				+ ", getPmfMassToleranceUnit()=" + getPmfMassToleranceUnit()
				+ ", getPrecursorMassTolerance()=" + getPrecursorMassTolerance()
				+ ", getPrecursorMassToleranceUnit()=" + getPrecursorMassToleranceUnit()
				+ ", getScoringAlgorithm()=" + getScoringAlgorithm() + ", getTaxonomy()="
				+ getTaxonomy() + "]";
	}
	...
	public Set<AdditionalParameter> getAdditionalParameters() {
		...
		if (protocol.getAdditionalSearchParams() != null) {
			...
			List<FuGECommonOntologyParamType> parameters = protocol.getAdditionalSearchParams()
					.getParamGroup();
