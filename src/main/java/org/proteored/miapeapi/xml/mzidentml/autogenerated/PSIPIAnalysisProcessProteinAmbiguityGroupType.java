...
/**
 * A set of logically related results from a protein
 * 				detection, for example to represent conflicting assignments of
...
public class PSIPIAnalysisProcessProteinAmbiguityGroupType
    extends FuGECommonIdentifiableType
{

    @XmlElement(name = "ProteinDetectionHypothesis", required = true)
    protected List<PSIPIAnalysisProcessProteinDetectionHypothesisType> proteinDetectionHypothesis;
    @XmlElements({
     ...
     * {@link PSIPIAnalysisProcessProteinDetectionHypothesisType }
     * 
     * 
     */
    public List<PSIPIAnalysisProcessProteinDetectionHypothesisType> getProteinDetectionHypothesis() {
        if (proteinDetectionHypothesis == null) {
            proteinDetectionHypothesis = new ArrayList<PSIPIAnalysisProcessProteinDetectionHypothesisType>();
        }
