package org.proteored.miapeapi.xml.mzidentml.util;
...
public class MzidentmlControlVocabularyXmlFactory {
	 ...
	 * @return a string
	 */
	public static String readEntireParam(FuGECommonOntologyParamType param) {
	 ...
	 * @return a string
	 */
	public static String readEntireParam(ParamType paramType) {
		StringBuilder sb = new StringBuilder();
	 ...
	 * @return a string
	 */
	public static String readEntireParamList(ParamListType paramList) {
		StringBuilder sb = new StringBuilder();
		List<FuGECommonOntologyParamType> parameters = paramList.getParamGroup();
		int counter = 1;
		for (FuGECommonOntologyParamType parameter : parameters) {
	 ...
	 * @return a string
	 */
	public static String readEntireParamList(List<FuGECommonOntologyParamType> paramList) {
		StringBuilder sb = new StringBuilder();
		int counter = 1;
		for (FuGECommonOntologyParamType parameter : paramList) {
			sb.append(readEntireParam(parameter));
	 ...
	 * @return a string
	 */
	public static String readEntireCVParamList(List<FuGECommonOntologyCvParamType> paramList,
			boolean withUnit) {
		StringBuilder sb = new StringBuilder();
		int counter = 1;
		for (FuGECommonOntologyParamType param : paramList) {
			String value = param.getValue();
			String name = param.getName();
			if (value == null || value.equals("")) {
				sb.append(name);
	 ...
	 */
	public static String readFirstUnitCVParamList(List<FuGECommonOntologyCvParamType> paramList) {
		for (FuGECommonOntologyParamType param : paramList) {
			String unitName = param.getUnitName();
			if (unitName != null && !unitName.equals("")) {
				return unitName;
