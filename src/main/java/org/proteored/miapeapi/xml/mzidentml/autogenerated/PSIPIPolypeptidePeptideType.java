...
/**
 *  One (poly)peptide (a sequence with
 * 				modifications).
 * 
...
public class PSIPIPolypeptidePeptideType
    extends FuGEBioConceptualMoleculeConceptualMoleculeType
{
    ...
    protected List<PSIPIPolypeptideModificationType> modification;
    @XmlElement(name = "SubstitutionModification")
    protected List<PSIPIPolypeptideSubstitutionModificationType> substitutionModification;
    @XmlElements({
     ...
     * {@link PSIPIPolypeptideModificationType }
     * 
     * 
     */
    public List<PSIPIPolypeptideModificationType> getModification() {
        if (modification == null) {
            modification = new ArrayList<PSIPIPolypeptideModificationType>();
        }
     ...
     * 
     */
    public List<PSIPIPolypeptideSubstitutionModificationType> getSubstitutionModification() {
        if (substitutionModification == null) {
            substitutionModification = new ArrayList<PSIPIPolypeptideSubstitutionModificationType>();
        }
