...
public class DatabaseImpl implements Database {
	private final PSIPIAnalysisSearchSearchDatabaseType xmlDatabase;

	public DatabaseImpl(PSIPIAnalysisSearchSearchDatabaseType xmlDatabase) {
	...
	public String getDate() {
		if (xmlDatabase.getReleaseDate() == null)
			return null;
		return xmlDatabase.getReleaseDate();
	}
	...
	public String getDescription() {
		...
		List<FuGECommonOntologyCvParamType> parameters = xmlDatabase.getCvParam();
		for (FuGECommonOntologyCvParamType param : parameters) {
	...
	public String getName() {
		ParamType databaseName = xmlDatabase.getDatabaseName();
