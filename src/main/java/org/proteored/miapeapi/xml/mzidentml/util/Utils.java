...
public class Utils {
	...
	public static Map<String, FuGECommonOntologyParamType> initParamMap(List<FuGECommonOntologyParamType> params) {
		Map<String, FuGECommonOntologyParamType> map = new THashMap<String, FuGECommonOntologyParamType>();
		if (params != null) {
			for (FuGECommonOntologyParamType param : params) {
				if (param instanceof FuGECommonOntologyCvParamType) {
					...
					FuGECommonOntologyUserParamType userParam = (FuGECommonOntologyUserParamType) param;
	...
	public static String writeParam(List<FuGECommonOntologyParamType> paramGroup) {
