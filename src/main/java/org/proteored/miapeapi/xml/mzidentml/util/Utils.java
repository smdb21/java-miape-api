...
public class Utils {
	...
	public static Map<String, FuGECommonOntologyParamType> initParamMap(
			List<FuGECommonOntologyParamType> params) {
		Map<String, FuGECommonOntologyParamType> map = new HashMap<String, FuGECommonOntologyParamType>();
		if (params != null) {
