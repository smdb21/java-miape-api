...
public class ModificationParamsType {
    ...
    protected List<PSIPIAnalysisSearchSearchModificationType> searchModification;
     ...
     * {@link PSIPIAnalysisSearchSearchModificationType }
     * 
     * 
     */
    public List<PSIPIAnalysisSearchSearchModificationType> getSearchModification() {
        if (searchModification == null) {
            searchModification = new ArrayList<PSIPIAnalysisSearchSearchModificationType>();
        }
