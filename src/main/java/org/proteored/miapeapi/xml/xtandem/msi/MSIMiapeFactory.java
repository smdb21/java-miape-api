...
public class MSIMiapeFactory {
	...
	public MiapeMSIDocument toDocument(MiapeXTandemFile xmlFile, PersistenceManager databaseManager,
		...
		try {
			...
			if (databaseManager == null) {
				result = new MiapeMsiDocumentImpl(xmlFile.toXTandemFile(), cvManager, miapeName, projectName);
			} else {
				result = new MiapeMsiDocumentImpl(xmlFile.toXTandemFile(), databaseManager, cvManager, userName,
