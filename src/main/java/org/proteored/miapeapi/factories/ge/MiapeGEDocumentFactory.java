...
public class MiapeGEDocumentFactory {
	...
	public static MiapeGEDocumentBuilder createMiapeGEDocumentBuilder(Project project, String name,
			User user) {
	...
	public static ImageAcquisitionEquipmentBuilder createImageAcquisitionEquipmentBuilder(
			String name) {
	...
	public static ImageGelElectrophoresisBuilder createImageGelElectrophoresisBuilder(
			String imageName) {
	...
	public static SampleApplicationBuilder createSampleApplicationBuilder(
			String sampleApplicationName) {
