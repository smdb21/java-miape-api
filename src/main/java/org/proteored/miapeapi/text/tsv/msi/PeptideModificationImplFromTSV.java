...
public class PeptideModificationImplFromTSV implements PeptideModification {
	...
	private static final org.apache.log4j.Logger log = org.apache.log4j.Logger
			.getLogger(PeptideModificationImplFromTSV.class);
	private static Set<String> errorMessages = new THashSet<String>();

	public PeptideModificationImplFromTSV(DTASelectModification dtaSelectModification) {
