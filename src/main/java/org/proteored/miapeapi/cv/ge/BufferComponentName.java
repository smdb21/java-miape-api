...
public class BufferComponentName extends ControlVocabularySet {
	private static BufferComponentName instance;
	 ...
	 */
	public static BufferComponentName getInstance(ControlVocabularyManager cvManager) {
		if (instance == null)
			instance = new BufferComponentName(cvManager);
		return instance;
	}

	private BufferComponentName(ControlVocabularyManager cvManager) {
		super(cvManager);
