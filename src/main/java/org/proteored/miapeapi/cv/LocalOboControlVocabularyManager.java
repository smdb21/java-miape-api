 ...
 * 
 */
public class LocalOboControlVocabularyManager extends OboControlVocabularyManager implements
		ControlVocabularyManager {

	public LocalOboControlVocabularyManager() {
		super(OboControlVocabularyManager.LOCAL_OBO, false);
	}
}
