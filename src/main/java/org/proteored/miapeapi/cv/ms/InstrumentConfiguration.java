...
public class InstrumentConfiguration extends ControlVocabularySet {
	...
	public static InstrumentConfiguration getInstance(ControlVocabularyManager cvManager) {
		if (instance == null)
			instance = new InstrumentConfiguration(cvManager);
		return instance;
	}

	// "MS:1000031" -> instrument model
	private InstrumentConfiguration(ControlVocabularyManager cvManager) {
		super(cvManager);
