...
public class SoftwareManufacturer extends ControlVocabularySet {
	public static final String SOFTWARE_MANUFACTURER_ACCESSION = "MS:1001267";
	 ...
	 */
	private static SoftwareManufacturer instance;

	public static SoftwareManufacturer getInstance(ControlVocabularyManager cvManager) {
		if (instance == null)
			instance = new SoftwareManufacturer(cvManager);
		return instance;
	}

	private SoftwareManufacturer(ControlVocabularyManager cvManager) {
		super(cvManager);
		String[] parentAccessionsTMP = { SOFTWARE_MANUFACTURER_ACCESSION };
		String[] explicitAccessionsTMP = { "MS:1000690", "MS:1000689", "MS:1000691", "MS:1001949",
				"MS:1000692", "MS:1001798", "MS:1000871", "MS:1001557", "MS:1000693", "MS:1000694",
				"MS:1001455", " MS:1001456", "sep:00060" };
		this.explicitAccessions = explicitAccessionsTMP;
		this.parentAccessions = parentAccessionsTMP;
		this.miapeSection = 501;
